var runThis = function runGame(size){
	var shipLocation;
	function Random() {
	...
	while (gameStarted === false){
		startGame = prompt("Hi "+userName+". A dangerous enemy battleship is coming our way! You can destroy it by hitting three shots. Enter a number between 0 and "+runThis+" to shoot. If you miss three shots the enemies will reach our ship and destroy us.\n\nWrite: 'I am ready!' to start the battle."); 
